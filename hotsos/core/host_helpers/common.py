...
class HostHelpersBase(abc.ABC):
    ...
    @abc.abstractmethod
    def cache_load(self, plugin=True):
        # default to loading from plugin cache since global cache may not be
        # suitable.
        pass

    @abc.abstractmethod
    def cache_save(self, plugin=True):
        # default to saving to plugin cache since global cache may not be
        # suitable.
        pass
