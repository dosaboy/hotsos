...
class HotSOSConfigOpts(ConfigOptGroupBase):
    ...
    def __init__(self):
        ...
        self.add(ConfigOpt(name='force_mode',
                           description=('Hotsos will normally gate running '
                                        'plugins on a criteria. Setting this '
                                        'to True bypasses these conditions '
                                        'and forces all plugins to run'),
                           default_value=False))
        self.add(ConfigOpt(name='global_tmp_dir',
                           description=('An ephemeral path that persists the '
                                        'execution of all plugins.'),
                           default_value=None))
        ...
        self.add(ConfigOpt(name='machine_readable',
                           description=('If this is set to True, the summary '
                                        'output will contain extra '
                                        'information that might be useful '
                                        'if the output is being read by an '
                                        'application.'),
                           default_value=False))
        ...
        self.add(ConfigOpt(name='repo_info',
                           description='Source repository sha1',
                           default_value=None))
